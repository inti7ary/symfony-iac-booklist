    ...
    <div v-if="is_initialized" id='profile-card' class="card bg-light" style="max-width: 640px;">
        <div style="position: relative;" class="row no-gutters jumbotron">
            <div v-if="!isEdited" style="position: absolute; right: 3%; top: 3%;" >
                <a @click.prevent="enableProfileEditing" href="#">редактировать</a>
            </div>
             
              <a v-if="isEdited" style="position: absolute; right: 3%; top: 3%;" @click.prevent="handePatchRequest" href="#">сохранить</a>
            <div class="col-md-6">
                ...
                <a v-if="!isPasswordEdited && !isEdited" @click.prevent="enablePasswordEditing" href="#">изменить пароль</a>
                <div v-if="isPasswordEdited" class="row justify-content-center" id="password-reset">
                        ...
                        <span class="invalid-feedback d-block">{{new_password_error}}</span>
                          ...
                          <button class="btn btn-info"  @click.prevent="handlePasswordReset">сохранить</button>
                </div>
